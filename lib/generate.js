...
var TestSectionTpl = require("../templates/test_section.js.tpl");
var TestHandlerTpl = require("../templates/test_handler.js.tpl");

var main = module.exports = function() {
    // check routes path
    var routes = Object.assign({}, require('./routes.json'));
    if (!routes.defines) {
